...
public class Lab5_4 {
	...
	public static void main(String[] args) {
        ...
        driver.findElement(By.id("input-firstname")).sendKeys("Akanksha");
        driver.findElement(By.id("input-lastname")).sendKeys("Choudhary");
        driver.findElement(By.id("input-email")).sendKeys("akankshach@gmail.com");
        driver.findElement(By.id("input-telephone")).sendKeys("893799");
        driver.findElement(By.id("input-password")).sendKeys("Abn@cef12");
        driver.findElement(By.id("input-confirm")).sendKeys("Abn@cef12");
